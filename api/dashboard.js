...
export default async function handler(req, res) {
  ...
  // Log for debugging (visible in Vercel runtime logs only)
  console.log(`Dashboard auth: key_len=${key ? key.length : null}, env_exists=${!!envKey}, env_len=${envKey ? envKey.length : null}`);
